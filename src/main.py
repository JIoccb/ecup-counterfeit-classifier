...
def main():
    ...
    parser.add_argument("--w_text", type=float, default=0.33, help="Вес текстовой модальности для weighted.")
    parser.add_argument("--w_img", type=float, default=0.34, help="Вес визуальной модальности для weighted.")
    parser.add_argument("--w_tab", type=float, default=0.33, help="Вес табличной модальности для weighted.")
